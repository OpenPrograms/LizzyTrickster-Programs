...
function signal:handleBlockUpdate (event_name, block_id, occupied, is_local) 
...
function signal:handleAspect (event_name, signal_id, aspect, is_local)
...
function signal:setupEventHandlers ()
