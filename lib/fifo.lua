-- This file is licensed under MIT and is Copyright (c) 2015 daurnimator
-- The original file can be found at https://github.com/daurnimator/fifo.lua/blob/master/fifo.lua
